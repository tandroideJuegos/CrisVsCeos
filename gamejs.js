...
function presentacionMode(){
    ...
    ctx.fillText("TANDROIDE JUEGOS Y CENTRO BARRIAL INDEPENDENCIA PRESENTAN", baseCanvas.width /2, baseCanvas.height*0.1 + tandroide.height + 30, baseCanvas.width-20);
    ctx.drawImage(logoIndepe, (baseCanvas.width - logoIndepe.width)/2, baseCanvas.height*0.1 + tandroide.height + 30 + 20);
